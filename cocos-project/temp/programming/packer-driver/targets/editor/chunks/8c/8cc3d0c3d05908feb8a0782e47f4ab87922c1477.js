    ...
    execute: function () {
      ...
      _export("CellComponent", CellComponent = (_dec = ccclass('CellComponent'), _dec2 = property({
        ...
        ensureClickable() {
          ...
          const button = (_this$node$getCompone = this.node.getComponent(Button)) != null ? _this$node$getCompone : this.node.addComponent(Button);
        ...
        onButtonClick() {
          ...
          const grid = (_this$node$parent = this.node.parent) == null ? void 0 : _this$node$parent.getComponent('Match3GridComponent');
