      ...
      _export("DressRoomPanel", DressRoomPanel = (_dec = ccclass('DressRoomPanel'), _dec2 = property({
        ...
        initTabs() {
          ...
          var _loop = function _loop() {
            ...
            var btn = _this.ensureButton(child, 120, 44);

            btn.node.on(Button.EventType.CLICK, () => {
              _this.switchTab(part);
            }, _this);
          };
        ...
        createItemButton(attachment) {
          ...
          if (this.itemPrefab) {
            ...
            var transform = itemNode.addComponent(UITransform);
          ...
          var btn = this.getOrCreateButton(itemNode, 220, 48);
          btn.node.on(Button.EventType.CLICK, () => {
        ...
        getOrCreateButton(node, width, height) {
          ...
          var existingButton = (_node$getComponent2 = node.getComponent(Button)) != null ? _node$getComponent2 : node.getComponentInChildren(Button);
