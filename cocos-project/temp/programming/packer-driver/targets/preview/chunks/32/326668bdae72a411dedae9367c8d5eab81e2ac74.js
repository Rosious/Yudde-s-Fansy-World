      ...
      _export("MainGameFlow", MainGameFlow = (_dec = ccclass('MainGameFlow'), _dec(_class = (_class2 = class MainGameFlow extends Component {
        constructor() {
          ...
          this.onMatchCleared = payload => {
            for (var item of (_payload$clearedItems = payload.clearedItems) != null ? _payload$clearedItems : []) {
        ...
        configureSceneCamera() {
          ...
          var scene = (_director$getScene = director.getScene == null ? void 0 : director.getScene()) != null ? _director$getScene : this.node.parent;
          var cameraNode = scene == null ? void 0 : scene.getChildByName('Main Camera');
          var canvasNode = scene == null ? void 0 : scene.getChildByName('Canvas');
          var camera = cameraNode == null ? void 0 : cameraNode.getComponent(Camera);
          var canvas = canvasNode == null ? void 0 : canvasNode.getComponent(Canvas);
        ...
        bindBottomButtons() {
          var canvas = this.findCanvasNode();
          var bottomBar = canvas == null ? void 0 : canvas.getChildByName('BottomBar');
        ...
        bindButton(buttonNode, handler, debugName) {
          ...
          var button = (_buttonNode$getCompon = buttonNode.getComponent(Button)) != null ? _buttonNode$getCompon : buttonNode.addComponent(Button);
        ...
        loadGameScene(key) {
          ...
          var sceneName = SCENE_BY_KEY[key];
          var currentScene = director.getScene();
          var currentSceneName = (_currentScene$name = currentScene == null ? void 0 : currentScene.name) != null ? _currentScene$name : currentScene == null ? void 0 : currentScene._name;
          ...
          var loadScene = director.loadScene;
        ...
        updateBottomButtonState() {
          ...
          var currentScene = director.getScene();
          var currentSceneName = (_currentScene$name2 = currentScene == null ? void 0 : currentScene.name) != null ? _currentScene$name2 : currentScene == null ? void 0 : currentScene._name;
          var activeKey = Object.keys(SCENE_BY_KEY).find(key => SCENE_BY_KEY[key] === currentSceneName);
          var buttonMap = {
            match: 'BtnMatch',
            shop: 'BtnShop',
            dress: 'BtnDress'
          ...
          for (var key of Object.keys(buttonMap)) {
            var buttonNode = bottomBar.getChildByName(buttonMap[key]);
